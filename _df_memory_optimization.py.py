...
def df_memory_optimization(df, object=False):
    """Reduce the size of the input dataframe

    Parameters
    ----------
    df: pd.DataFrame, Required
        input DataFrame which needs to reduce the memory usage.
    object : bool, Optional
        if true, try to convert object to category, defaault is False
